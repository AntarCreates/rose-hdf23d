...
def visualize_comparison(original_pcd, filtered_pcd):
    ...
    """
    # Create a copy of the point clouds and assign colors
    original_display = original_pcd.clone()
    filtered_display = filtered_pcd.clone()
    
    # Set colors: original in red, filtered in green
